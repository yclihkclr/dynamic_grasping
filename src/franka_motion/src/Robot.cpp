...
#include "franka_motion/QuinticPolynomial.hpp"
#include <franka_motion/Robot.h>
#include <franka_motion/geometry_math.h>
#include <boost/optional.hpp>
#include <franka_motion/Payload.h>
#include "franka_motion/examples_common.h"
...
bool Robot::hasErrors() {
    return bool(robot.readOnce().current_errors);
}
...
void Robot::setDefaultBehavior() {
    robot.setCollisionBehavior(
            {{20.0*3, 20.0*3, 18.0*3, 18.0*3, 16.0*3, 14.0*3, 12.0*3}}, {{20.0*3, 20.0*3, 18.0*3, 18.0*3, 16.0*3, 14.0*3, 12.0*3}},
            {{20.0*3, 20.0*3, 18.0*3, 18.0*3, 16.0*3, 14.0*3, 12.0*3}}, {{20.0*3, 20.0*3, 18.0*3, 18.0*3, 16.0*3, 14.0*3, 12.0*3}},
            {{20.0*3, 20.0*3, 20.0*3, 25.0*3, 25.0*3, 25.0*3}},         {{20.0*3, 20.0*3, 20.0*3, 25.0*3, 25.0*3, 25.0*3}},
            {{20.0*3, 20.0*3, 20.0*3, 25.0*3, 25.0*3, 25.0*3}},         {{20.0*3, 20.0*3, 20.0*3, 25.0*3, 25.0*3, 25.0*3}});
